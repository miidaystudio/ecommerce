...
export function Topbar() {
  ...
  return (
    <header className="flex h-16 items-center justify-between border-b border-border bg-background px-8">
      <div className="flex w-80 items-center gap-2.5 rounded bg-surface px-3.5 py-2">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#7A756B" strokeWidth={2}>
